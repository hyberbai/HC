...
public class TextCodingUtils {
	...
	private static final int BIG5 = 6;
    //static final int EUC_TW = 7;
	private static final int TOTAL_ENCODINGS = 4;
 
    // Frequency tables to hold the GB, Big5, and EUC-TW character
    // frequencies
    private static int GBFreq[][];
    private static int GBKFreq[][];
    private static int Big5Freq[][];
    private static int EUC_TWFreq[][];
    ...
    public static String detectEncodingCharset(byte[] rawtext) {
    	int encoding_guess = detectEncoding(rawtext);
    	if(encoding_guess == GB2312) return "GB2312";
    	if(encoding_guess == UNICODE) return "UNICODE";
    	if(encoding_guess == GBK) return "GBK";
    	if(encoding_guess == BIG5) return "BIG5";
    	 return "UTF-8";
    }
