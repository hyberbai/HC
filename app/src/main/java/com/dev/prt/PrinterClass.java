...
public interface PrinterClass {
	...
	public static final int STATE_SCANING = 7;// 扫锟斤拷状态
	...
	public static final int MESSAGE_PRT_STATE = 100;

	public static final int STATE_PRT_SUCCESS = 1;
	public static final int STATE_PRT_FAIL = 4;
