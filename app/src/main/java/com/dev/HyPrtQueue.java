...
public class HyPrtQueue {

	private static  final String TAG = HyPrtQueue.class.getSimpleName();
	...
	public HyPrtQueue(Context context,PosApi api){
	...
	private void print() {
		...
		if(type == PRINT_TYPE_TEXT)
			printText();
		else if(type == PRINT_TYPE_BMP)
			printImage();
	}
